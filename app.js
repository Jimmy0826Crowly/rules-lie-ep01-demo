...
const scenes = [
  {
    ...
    title: "红字砸城",
    bg: "city",
    art: "./assets/scenes/ep01-grid01.png",
    className: "crimson",
    speaker: "广播",
    tone: "失真平稳",
    line: "日落后，紧闭门窗。",
  ...
  },
  {
    ...
    title: "街道恐慌",
    bg: "street",
    art: "./assets/scenes/ep01-grid02.png",
    className: "crimson",
    speaker: "路人甲",
    tone: "嘶喊",
    line: "跑啊——！",
  ...
  },
  {
    ...
    title: "整楼闭门",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid03.png",
    speaker: "环境",
    tone: "连环关门声",
    line: "一扇扇门亮灯，又熄灭。",
    sub: "服从来得比理解快。",
  ...
  },
  {
    ...
    title: "先固守",
    bg: "home",
    art: "./assets/scenes/ep01-grid04.png",
    speaker: "朱冠宇",
    tone: "低声自语",
    line: "先固守，再求援。",
    sub: "受过训练的人，恐慌也有章法。",
  ...
  },
  {
    ...
    title: "两副碗筷",
    bg: "home",
    art: "./assets/scenes/ep01-grid05.png",
    speaker: "朱冠宇",
    tone: "日常",
    line: "小满？开饭了！",
    sub: "他还不知道，家里只剩他一个。",
  ...
  },
  {
    ...
    title: "画室空了",
    bg: "home",
    art: "./assets/scenes/ep01-grid06.png",
    speaker: "朱冠宇",
    tone: "气音",
    line: "小满？",
    sub: "湿颜料说明她刚走不久。",
  ...
  },
  {
    ...
    title: "手背试温",
    bg: "door",
    art: "./assets/scenes/ep01-grid07.png",
    speaker: "环境",
    tone: "楼道脚步逼近",
    line: "门外有不属于人类节奏的脚步。",
    sub: "消防员本能在说：门外有「火」。",
  ...
  },
  {
    ...
    title: "老王被拖走",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid08.png",
    className: "crimson",
    speaker: "老王",
    tone: "掐断",
    line: "救——",
  ...
  },
  {
    ...
    title: "广播循环",
    bg: "home",
    art: "./assets/scenes/ep01-grid09.png",
    speaker: "广播",
    tone: "毫无波澜",
    line: "不要回应任何敲门声。",
    sub: "广播的冷静比怪物更可怕。",
  ...
  },
  {
    ...
    title: "伪小满",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid10.png",
    speaker: "门外",
    tone: "甜糯渐扭曲",
    line: "哥，开门呀。",
    sub: "规则会用你最爱的声音敲门。",
  ...
  },
  {
    ...
    title: "黄发绳",
    bg: "door",
    art: "./assets/scenes/ep01-grid11.png",
    speaker: "朱冠宇",
    tone: "牙缝里",
    line: "小满怕黑，从不敲门。",
    sub: "十二年兄妹，假声音骗不过细节。",
  ...
  },
  {
    ...
    title: "纸条飘落",
    bg: "home",
    art: "./assets/scenes/ep01-grid12.png",
    speaker: "朱冠宇",
    tone: "一字一顿",
    line: "她知道会有今晚。",
    sub: "妹妹不是失踪，是提前知道。",
  ...
  },
  {
    ...
    title: "暖色闪回",
    bg: "home",
    art: "./assets/scenes/ep01-grid13.png",
    className: "warm",
    speaker: "小满",
    tone: "闪回画外",
    line: "哥，规则就是用来骗人的。",
  ...
  },
  {
    ...
    title: "红字渗出",
    bg: "door",
    art: "./assets/scenes/ep01-grid14.png",
    className: "crimson",
    speaker: "环境",
    tone: "木纹渗血",
    line: "门板上，红字从木纹里渗出来。",
  ...
  },
  {
    ...
    title: "第一行",
    bg: "door",
    art: "./assets/scenes/ep01-grid15.png",
    className: "crimson",
    speaker: "朱冠宇",
    tone: "声音发紧",
    line: "紧闭、门窗。",
  ...
  },
  {
    ...
    title: "第二行",
    bg: "door",
    art: "./assets/scenes/ep01-grid16.png",
    className: "crimson",
    speaker: "朱冠宇",
    tone: "气音",
    line: "……第二行？",
  ...
  },
  {
    ...
    title: "瞳孔倒影",
    bg: "door",
    art: "./assets/scenes/ep01-grid17.png",
    className: "crimson",
    speaker: "朱冠宇",
    tone: "自语",
    line: "广播说闭门……门说开门。",
  ...
  },
  {
    ...
    title: "我去找你",
    bg: "home",
    art: "./assets/scenes/ep01-grid18.png",
    speaker: "朱冠宇",
    tone: "低而稳",
    line: "我去找你。",
    sub: "决心下完，这个人立住了。",
  ...
  },
  {
    ...
    title: "最后警告",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid19.png",
    className: "crimson",
    speaker: "广播",
    tone: "近乎温柔",
    line: "最后警告。不要、开门。",
  ...
  },
  {
    ...
    title: "隔门审判",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid20.png",
    speaker: "对门男",
    tone: "隔门嘶喊",
    line: "不要命了？！锁门！",
    sub: "群体的「正确」开始审判他。",
  ...
  },
  {
    ...
    title: "两短一长",
    bg: "door",
    art: "./assets/scenes/ep01-grid21.png",
    speaker: "环境",
    tone: "呼吸声特写",
    line: "两短，一长。",
    sub: "他不是不怕，是会处理怕。",
  ...
  },
  {
    ...
    title: "开门确认",
    bg: "door",
    art: "./assets/scenes/ep01-grid22.png",
    className: "crimson",
    speaker: "朱冠宇",
    tone: "平静",
    line: "我开门了。",
  ...
  },
  {
    ...
    title: "雾绕行",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid23.png",
    className: "crimson",
    speaker: "环境",
    tone: "深海雾流",
    line: "雾在他身体两侧分开。",
  ...
  },
  {
    ...
    title: "闭门者收",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid24.png",
    className: "crimson",
    speaker: "雾中群声",
    tone: "呢喃叠加",
    line: "闭门者……收。",
  ...
  },
  {
    ...
    title: "救不了",
    bg: "door",
    art: "./assets/scenes/ep01-grid25.png",
    speaker: "朱冠宇",
    tone: "嘶喊",
    line: "开门！快开门——！",
    sub: "他想救，但每扇门都替主人选了死。",
  ...
  },
  {
    ...
    title: "为什么是我",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid26.png",
    speaker: "朱冠宇",
    tone: "哑声",
    line: "为什么是我……",
  ...
  },
  {
    ...
    title: "第一个清晨",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid27.png",
    className: "dawn",
    speaker: "环境",
    tone: "真空后鸟鸣",
    line: "天光渐亮，雾由浓转薄。",
  ...
  },
  {
    ...
    title: "空屋",
    bg: "home",
    art: "./assets/scenes/ep01-grid28.png",
    speaker: "朱冠宇",
    tone: "苦笑",
    line: "就剩咱俩了？",
    sub: "用一只猫衡量一栋楼的死寂。",
  ...
  },
  {
    ...
    title: "天台望城",
    bg: "city",
    art: "./assets/scenes/ep01-grid29.png",
    className: "dawn",
    speaker: "朱冠宇",
    tone: "望城",
    line: "小满，你在哪。",
  ...
  },
  {
    ...
    title: "同一只手",
    bg: "home",
    art: "./assets/scenes/ep01-grid30.png",
    speaker: "环境",
    tone: "纸张摩擦",
    line: "纸条笔迹与第二行红字一模一样。",
    sub: "全剧最大伏笔，静悄悄埋下。",
  ...
  },
  {
    ...
    title: "幸存小队",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid31.png",
    speaker: "马一鸣",
    tone: "画外咋呼",
    line: "这楼昨晚红光最大！肯定全没了！",
    sub: "幸存者来「收尸」捡物资。",
  ...
  },
  {
    ...
    title: "楼道遭遇",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid32.png",
    speaker: "谭天",
    tone: "低喝",
    line: "站住！",
  ...
  },
  {
    ...
    title: "门都是好的",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid33.png",
    speaker: "真涵",
    tone: "声音发颤",
    line: "门都是好的……他从里面活下来的。",
    sub: "专业的人最先意识到不可能。",
  ...
  },
  {
    ...
    title: "全城闭门",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid34.png",
    speaker: "谭天",
    tone: "一字一句",
    line: "昨晚全城闭门的都没了。",
    sub: "不止这栋楼，是全城。",
  ...
  },
  {
    ...
    title: "枪口入画",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid35.png",
    className: "crimson",
    speaker: "谭天",
    tone: "扣住扳机",
    line: "全楼就你活着——",
  ...
  },
  {
    ...
    title: "你是人是鬼",
    bg: "corridor",
    art: "./assets/scenes/ep01-grid36.png",
    className: "blackout",
    speaker: "谭天",
    tone: "黑屏画外",
    line: "你是人是鬼？",
...
function renderScene() {
  ...
  els.sceneImage.src = scene.art || assets[scene.bg];
